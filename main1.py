...
import string
from easygui import buttonbox, enterbox  # Import buttonbox and enterbox functions
...
def func(input_text):
    ...
    a = input_text.lower()  # Convert input to lowercase
...
while 1:
    ...
    choices = ["Input Text", "All Done!"]
    reply = buttonbox(msg, image=image, choices=choices)
    if reply == choices[0]:
        input_text = enterbox("Enter your text:")
        func(input_text)
    if reply == choices[1]:
        quit()